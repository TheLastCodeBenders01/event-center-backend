package com.thelastcodebenders.event_center_backend.adapter;
...
//    @Value("${superbase.access-key-id}")
//    private String SUPERBASE_API_KEY;
//
//    @Value("${superbase.access-key-secret}")
//    private String accessKeySecret;

    @Value("${superbase.auth-token}")
    private String SUPERBASE_AUTH_TOKEN;
    private String BASE_URL = "https://ublskkqnccslroaritlt.supabase.co/storage/v1/object/public/event-center-media-uploads//";
    private final String SUPABASE_PROJECT_URL = "https://ublskkqnccslroaritlt.supabase.co";
    private final String BUCKET_NAME = "event-center-media-uploads";
    ...
    public List<String> buildFileUri(List<String> fileNames) {
        return fileNames.parallelStream().map(
                fileName -> String.format("%s%s", BASE_URL, fileName)
